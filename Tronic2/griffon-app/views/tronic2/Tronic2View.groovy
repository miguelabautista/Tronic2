...
application(name: 'bienvenidoScreen', id: 'bienvenidoScreen', title: 'BIENVENIDO',
    ...
    panel(layout: new MigLayout('insets 6 5 0 0')) {
        ...
        hudButton(name: 'ingresarButton', id: 'ingresarButton', text: 'Ingresar', enabled: bind {passwordText.enabled == true}, mnemonic: 'I', preferredSize: [71, 23], constraints: 'gapleft 121, split2', actionPerformed: controller.entrar, focusGained: controller.foco)
...
//TODO: corregir
//bienvenidoScreen.setSize(420,328)
